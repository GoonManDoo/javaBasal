...
public class FriendExample {
   public static void main(String[] args) {
     ...
     Friend f1 = new Friend(); //규칙 외우기
     f1.friendName = "권가희";
     f1.friendPhone = "010-1111-2222";
     f1.email = "kkh@email.com";
     f1.height = 167.5;
     f1.weight = 55.7;
     
     Friend f2 = new Friend(); //규칙 외우기
     f2.friendName = "이유빈";
     f2.friendPhone = "010-3333-4444";
     f2.email = "lyb@email.com";
     f2.height = 156.5;
     f2.weight = 45.7;
     
     Friend f3 = new Friend(); //규칙 외우기
     f3.friendName = "나현주";
     f3.friendPhone = "010-4444-5555";
